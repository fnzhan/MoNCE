...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--cost_type', type=str, default='hard', help='hard weighting or easy weighting')
        parser.add_argument('--eps', type=float, default=1.0, help='epsilon of OT')
        parser.add_argument('--neg_term_weight', type=float, default=1.0, help='weight of negative term')
