...
PatchNCE =  [47.89, 47.53, 46.93, 45.33, 44.23, 43.23]
WeightNCE = [45.99, 45.39, 44.39, 42.92, 42.42, 42.03]
MoNCE =     [45.22, 44.46, 43.37, 41.86, 41.41, 41.19]
x =         [0.01, 0.1,   0.5,   1,     2,    5]
plt.subplot(1, 4, 3)
plt.grid(b=True)
plt.xticks(x)
plt.plot(x, PatchNCE, marker='v', markersize=8, label='PatchNCE')
...
plt.ylabel("FID Score", fontsize=12)
plt.title("ADE20K (Semantic)", fontsize=16)
plt.savefig('im_ablation2.png', bbox_inches='tight')